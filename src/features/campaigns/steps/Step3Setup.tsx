    ...
    <div className="max-w-4xl mx-auto space-y-6">
      ...
      <section className="rounded-xl border border-slate-800 bg-slate-900/40 p-5">
        ...
        <input
          ...
          className="w-full md:w-96 bg-slate-950 border border-slate-700 text-sm text-white rounded-lg px-3 py-2 focus:outline-none focus:ring-2 focus:ring-brand-500"
        />
      </section>
