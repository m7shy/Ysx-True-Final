...
export interface PublicSettings {
  zohoClientId: string;
  // zohoClientSecret is securely handled in SecureState
  ...
  useRealApi: boolean;
  transportMode: 'gateway-imap-smtp' | 'oauth-api'; // New Setting
  activeProvider: 'ZOHO' | 'GMAIL';
...
export class AppError extends Error {
  ...
  constructor(code: AppErrorCode, provider: 'ZOHO' | 'GOOGLE' | 'SYSTEM', message: string) {
    super(message);
    this.code = code;
